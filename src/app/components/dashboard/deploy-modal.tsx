...
const PROTOCOLS = ["mETH Protocol", "Agni Finance", "Merchant Moe", "USDY", "Fluxion"];
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between px-8 py-6 border-b border-border">
                ...
                <button
                  onClick={onClose}
                  className="font-mono text-muted hover:text-ink transition-colors text-lg"
                >
                  ×
                </button>
              </div>
              ...
              <div className="px-8 py-8">
                {deployed ? (
                  <div className="text-center py-10">
                    ...
                    <p className="font-mono text-[0.58rem] text-ink-soft mb-6 tracking-[0.05em]">
                      ERC-8004 Agent #{Math.floor(Math.random() * 9000) + 1000} is live on Mantle
                    </p>
                    <button
                      onClick={reset}
                  ...
                  <div className="text-center py-14 space-y-5">
                    ...
                    />
                    <p className="font-mono text-[0.6rem] text-ink-soft tracking-[0.08em]">
                      Generating strategy, running tests...
                    </p>
                  </div>
                ) : step === 1 ? (
                  <div className="space-y-6">
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="e.g. Allocate 60% to mETH staking protocol, provide 40% as liquidity to Agni Finance mETH/USDC pool, rebalance weekly, compound rewards automatically..."
                        value={intent}
                    ...
                    <button
                      onClick={() => setStep(2)}
                      className="font-display italic text-white bg-ink px-8 py-2.5 text-sm tracking-[0.03em] hover:bg-accent transition-colors w-full"
                    >
                      Continue
                    </button>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex gap-3">
                      <button
                        onClick={() => setStep(1)}
                        className="font-mono text-[0.55rem] tracking-[0.15em] uppercase text-ink-soft border border-border px-6 py-2.5 hover:bg-surface-alt transition-colors"
                      >
                        Back
                      </button>
                      <button
                        onClick={() => setStep(3)}
                        className="font-display italic text-white bg-ink px-8 py-2.5 text-sm tracking-[0.03em] hover:bg-accent transition-colors flex-1"
                      >
                        Review
                      </button>
                    </div>
                    ...
                    <div className="bg-surface-alt border border-border p-5 space-y-3 font-mono text-[0.6rem]">
                      <div className="flex justify-between">
                        ...
                        <span className="text-ink font-medium">
                          {intent || "mETH + Agni LP compound"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-ink-soft">Protocols</span>
                        <span className="text-ink font-medium">
                      ...
                      <div className="flex justify-between">
                        <span className="text-ink-soft">Allocation</span>
                        <span className="text-ink font-medium">{alloc}%</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-ink-soft">Network</span>
                        <span className="text-ink font-medium">Mantle</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-ink-soft">Identity</span>
                        <span className="text-ink font-medium">ERC-8004</span>
                      </div>
                    </div>
                    <p className="font-mono text-[0.52rem] text-ink-soft tracking-[0.08em] text-center">
                      The engine will generate Solidity, run Foundry tests, execute Halmos
                      verification, and deploy to Mantle.
                    </p>
                    <div className="flex gap-3">
                      <button
                        onClick={() => setStep(2)}
                      ...
                      <button
                        ...
                        className="font-display italic text-white bg-accent px-8 py-2.5 text-sm tracking-[0.03em] hover:bg-accent-light transition-colors flex-1"
                      >
                        Confirm & Deploy
                      </button>
                    </div>

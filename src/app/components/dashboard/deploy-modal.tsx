              ...
              <div className="px-8 py-8">
                ...
                {(step === 3 && !deploying && !deployed) || (deploying && pipeline.deploy === "pending") ? (
                  <div className="bg-[#fff7ed] border border-[#fed7aa] p-4 mb-6">
                    <div className="font-mono text-[0.55rem] text-[#ea580c] font-medium mb-1">⚠ Risk Warning</div>
                    <p className="font-mono text-[0.5rem] text-[#9a3412] leading-relaxed">
                      This contract is generated by AI and reviewed by an automated security agent. The review is not a professional audit. Never deposit more than you can afford to lose. Always review the source code and security findings before using with real funds.
                    </p>
                  </div>
                ) : null}
                ...
                {deployed && result ? (
                  <div className="text-center py-6">
                    ...
                    <h3 className="font-display font-semibold text-2xl mb-2">
                      {securityReport?.riskLevel === "high" ? "Deployment Complete — Review Required" : "Deployment Complete"}
                    </h3>
                    ...
                    <div className="bg-[#fff7ed] border border-[#fed7aa] p-4 mb-6 text-left max-w-[500px] mx-auto">
                      <p className="font-mono text-[0.48rem] text-[#9a3412] leading-relaxed">
                        {securityReport?.disclaimer || "⚠ AI-generated code carries inherent risk. This contract was automatically reviewed but has not been professionally audited. Always review contract code before depositing funds. Do not deposit more than you can afford to lose."}
                      </p>
                    </div>
